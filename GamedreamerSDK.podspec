#
#  Be sure to run `pod spec lint GamedreamerSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "byxzw" => "13725477762@163.com" }
  # Or just: spec.author    = "许振文"
  # spec.authors            = { "许振文" => "xuzhenwen@gamedreamer.com" }
  # spec.social_media_url   = "https://twitter.com/许振文"
